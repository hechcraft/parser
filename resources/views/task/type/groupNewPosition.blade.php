<div class="ui grid">
    <div class="five wide column center aligned">
        <h2 class="ui header">{{$lastOffer->name}}</h2>
        <a href="{{$lastOffer->offer_url}}" class="ui medium image">
            <img src="{{$lastOffer->image_url}}">
        </a>
        <p></p>
        <p>Последняя цена: {{$lastOffer->lastPrice->price_str}}</p>
        <p>Последняя проверка: {{$lastOffer->last_checked_at}}</p>
    </div>
